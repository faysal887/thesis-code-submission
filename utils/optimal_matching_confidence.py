# https://github.com/pterhoer/OptimalMatchingConfidence/blob/main/src/ConfidenceEstimator.py
# https://github.com/pterhoer/OptimalMatchingConfidence/blob/main/src/ConfidenceEstimator.py
...
class ConfidenceEstimator:
    def __init__(self, genuine_arr_path, imposter_arr_path):

        self._scores_gen = np.load(genuine_arr_path, allow_pickle=True)
        self._scores_imp =np.load(imposter_arr_path, allow_pickle=True)
